...
app.get("/api/expenses", (req, res, next) => {
    console.log("GET /api/expense called")
...
app.get("/api/expense/:id", (req, res, next) => {
    console.log("GET /api/expense:id called")
...
app.post("/api/expense/", (req, res, next) => {
    console.log("POST /api/expense called")
    var errors = []
    if (!req.body.item) {
...
app.put("/api/expense/:id", (req, res, next) => {
    var id = req.params.id;
    var errors = []
    console.log("PUT /api/expense/:id called")
    if (!req.body.item) {
        errors.push("No item specified");
    }
    var data = {
...
app.delete("/api/expense/:id", (req, res, next) => {
    var id = req.params.id;
    console.log("DELETE /api/expense/:id called")
